...
// constantes
 ...
 export const obtenerIpsSavedAccion = () => async (dispatch, getState) => {
    ...
    try{
        const res = await axios.get(`http://ec2-18-188-10-21.us-east-2.compute.amazonaws.com:8080/api/resource`)
       ...
       // y el payload seria todo el state (array y en el ejemplo de abajo array y offset)
        ...
        dispatch({
            type: GET_IPS_SAVED_EXITO,
            payload: [ {name:'Mock Name', score: 88} , {name:'Mock Name 2', score: 78} , {name:'Mock Name 3', score: 4} , {name:'Mock Name 4', score: 17} , {name:'Mock Name 5', score: 50} ,]
        })
    }
 }
